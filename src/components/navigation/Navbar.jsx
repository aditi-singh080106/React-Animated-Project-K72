...
const Navbar = () => {
  ...
  return (
    ...
    className='lg:h-16 h-10 lg:w-[16vw] w-48 relative bg-black'>
       <div ref={navGreenRef} className='absolute transition-all top-0 h-0 w-full bg-[#d3ef50]'>
        </div>
       <div  className='relative lg:px-12 px-8 py-6  flex flex-col justify-end items-end lg:gap-2 gap-1'>
